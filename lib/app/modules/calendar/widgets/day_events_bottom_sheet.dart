                  ...
                  itemBuilder: (context, index) {
                    if (index == 0) {
                      return Padding(
                        ...
                        child: Text(DateFormat('dd/MM/yy').format(day)),
                      );
                    } else {
                                    ...
                                    child: Align(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            '${DateFormat(Constants.kDateRangeFormat).format(event.begin)} - '
                                            '${DateFormat(Constants.kDateRangeFormat).format(event.end)}',
