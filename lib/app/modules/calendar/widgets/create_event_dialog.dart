...
import 'package:my_calender/app/modules/calendar/utils/extensions.dart';
import 'package:my_calender/app/modules/calendar/widgets/date_picker_title_widget.dart';
import 'package:my_calender/app/modules/calendar/widgets/picker_day_item_widget.dart';
...
class _CreateEventDialogState extends State<CreateEventDialog> {
  ...
  String _parseDateRange(DateTime begin, DateTime end) {
    if (begin.isAtSameMomentAs(end)) {
      return begin.format(Constants.kDateRangeFormat);
    } else {
      return '${begin.format(Constants.kDateRangeFormat)} - ${end.format(Constants.kDateRangeFormat)}';
    }
  }
    ...
    showCrDatePicker(
      ...
      properties: DatePickerProperties(
        ...
        controlBarTitleBuilder: (date) => Text(
          DateFormat(Constants.kAppBarDateFormat).format(date),
          style: const TextStyle(
            fontSize: 16,
            color: violet,
